                ...
                if (LISTAT2.get(1).getTOKEN() == "CL") {
                    if (LISTAT2.get(2).getTOKEN() == "IDU") {
                        if (LISTAT2.get(3).getTOKEN() == "LLA") {
                            ...
                            if (VARIOS.VALIDARVARIOS(listaTokens).size() == 0) {
                                //SI NO HAY ERRORES AVANZA
                                if (!listaTokens.isEmpty() && listaTokens.get(0).getTOKEN() == "LLC") {
                                    return errores;
                                } else {
                                    ERROR NUEVOITEM = new ERROR("ULTIMA", "SINTACTICO", "?", "SE ESPERABA LLC");
                                    errores.add(NUEVOITEM);
                                    return errores;
                                }
